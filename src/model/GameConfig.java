...
public class GameConfig {
    public static final double ENTITY_SCALE = 1;
    ...
    public static final int MOVE_SPEED = (int) (5 * ENTITY_SCALE);
    public static final int GRAVITY = (int) (1 * ENTITY_SCALE);
    public static final int JUMP_STRENGTH = (int) (-15 * ENTITY_SCALE);

    public static final int AGENT_SPEED = (int) (2 * ENTITY_SCALE);
